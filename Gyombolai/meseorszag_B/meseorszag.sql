...
--
-- Hoszt: localhost
-- Létrehozás ideje: 2012. jan. 04. 07:23
-- Szerver verzió: 5.1.53
-- PHP verzió: 5.3.4
...
--
-- Adatbázis: `meseország`
--

-- --------------------------------------------------------

--
-- Tábla szerkezet: `batorsag`
--

CREATE TABLE IF NOT EXISTS `batorsag` (
  `fokozat` int(11) NOT NULL AUTO_INCREMENT,
  `minosites` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`fokozat`)
...
--
-- Tábla szerkezet: `borzasztosag`
--

CREATE TABLE IF NOT EXISTS `borzasztosag` (
  `fokozat` int(11) NOT NULL AUTO_INCREMENT,
  `minosites` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`fokozat`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=10 ;
...
--
-- Tábla szerkezet: `kiraly`
--

CREATE TABLE IF NOT EXISTS `kiraly` (
  ...
  `cimer` varchar(12) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`kiralykod`)
...
--
-- Tábla szerkezet: `kiralylany`
--

CREATE TABLE IF NOT EXISTS `kiralylany` (
  `nev` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `apa` varchar(12) COLLATE utf8_unicode_ci NOT NULL,
  `eletkor` int(11) NOT NULL,
  `szepseg` int(11) NOT NULL,
  `fogvatarto` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`nev`),
  KEY `apa` (`apa`,`szepseg`)
...
--
-- Tábla szerkezet: `lovag`
--

CREATE TABLE IF NOT EXISTS `lovag` (
  `nev` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `cimer` varchar(22) COLLATE utf8_unicode_ci NOT NULL,
  `batorsag` int(11) NOT NULL,
  `orszaga` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `holgye` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `vagyon` int(11) NOT NULL,
  `had` int(11) NOT NULL,
  PRIMARY KEY (`nev`),
  KEY `batorsag` (`batorsag`,`orszaga`,`holgye`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `orszag` (
  `orszagnev` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `terulet` int(11) NOT NULL,
  `lakossag` int(11) NOT NULL,
  `kiralya` varchar(12) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`orszagnev`),
  KEY `kiralya` (`kiralya`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
-- Tábla szerkezet: `osellensegek`
--

CREATE TABLE IF NOT EXISTS `osellensegek` (
  `lovag` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `sarkany` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  KEY `lovag` (`lovag`,`sarkany`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
-- Tábla szerkezet: `sarkany`
--

CREATE TABLE IF NOT EXISTS `sarkany` (
  `nev` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `faj` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `eletkor` int(11) NOT NULL,
  `borzasztosag` int(11) NOT NULL,
  `testhossz` int(11) NOT NULL,
  `feszkelohely` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `nosteny` tinyint(1) NOT NULL,
  `kincs` int(11) NOT NULL,
  PRIMARY KEY (`nev`),
  KEY `feszkelohely` (`feszkelohely`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
-- Tábla szerkezet: `sarkanyfajta`
--

CREATE TABLE IF NOT EXISTS `sarkanyfajta` (
  `sarkanyfaj` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `tuzokado` tinyint(1) NOT NULL,
  `emberevo` tinyint(1) NOT NULL,
  `ropkepes` tinyint(1) NOT NULL,
  `fejszam` int(11) NOT NULL,
  PRIMARY KEY (`sarkanyfaj`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
-- Tábla szerkezet: `szepseg`
--

CREATE TABLE IF NOT EXISTS `szepseg` (
  `fokozat` int(11) NOT NULL AUTO_INCREMENT,
  `minosites` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`fokozat`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=10 ;
